    ...
    <div className={styles["leaderboard-page"]}>
      <nav className="navbar">
        ...
        <div className="nav-links">
          ...
          <Link to="/minigame" className="nav-link">
            Mini-jeux
          </Link>
      ...
      <div className={styles["leaderboard-container"]}>
        ...
        <p className={styles["subtitle"]}>
          Les meilleurs joueurs de Click Storm
        </p>
        ...
        {loading ? (
                  ...
                  return (
                    ...
                    >
                      ...
                      <td className={styles["player-col"]}>
                        {entry.username}
                        {isCurrentUser && (
                          <span className={styles["you-badge"]}>Vous</span>
                        )}
                      </td>
                      <td className={styles["score-col"]}>
                        {entry.best_score.toLocaleString()}
                      </td>
                      <td className={styles["games-col"]}>
                        {entry.games_played}
                      </td>
                    </tr>
                  );
          ...
          <div className={styles["no-data"]}>
            ...
            <Link to="/minigame" className={styles["play-button"]}>
              Jouer maintenant
            </Link>
          </div>
        )}
